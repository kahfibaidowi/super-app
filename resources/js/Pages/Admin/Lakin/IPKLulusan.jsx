...
const Page=(props)=>{
    ...
    const get_lakin=useQuery({
        queryKey:["get_lakin_ipk_lulusan", filter],
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-flex align-items-center">
                            <h4 class="page-title">Lakin (IPK Lulusan)</h4>
                        </div>
                    </div>
                </div>
...
const Table=(props)=>{
    ...
    const upsert_lakin=useMutation({
        ...
        onSuccess:data=>{
            queryClient.refetchQueries("get_lakin_ipk_lulusan")
        },
        onError:err=>{
            console.log(err)
                                ...
                                <tbody>
                                    {!props.data.isFetching?
                                        <>
                                            ...
                                            {!_.isNull(props.data.error)&&
                                                <tr>
                                                    <td colSpan={8} className="text-center cursor-pointer" onClick={()=>queryClient.refetchQueries("get_lakin_ipk_lulusan")}>
            ...
            <Formik
                ...
                validationSchema={
                    yup.object().shape({
                        ...
                        ipk_min:yup.string().required(),
                        ipk_avg:yup.string().required(),
                        ipk_max:yup.string().required()
                    })
                }
            >
                {formik=>(
                    <form onSubmit={formik.handleSubmit}>
                        <Modal.Header closeButton>
                            <h4 className="modal-title">Tambah IPK Lulusan</h4>
                        </Modal.Header>
                        <Modal.Body>
                            <div className="row">
                                <div className="col-12">
                                ...
                                <div className="col-12">
                                    <div className="mb-2">
                                        <label className="my-1 me-2" for="country">IPK Min <span className="text-danger">*</span></label>
                                        <NumericFormat
                                            className="form-control"
                                            value={formik.values.ipk_min}
                                            onValueChange={values=>{
                                                const {value}=values

                                                formik.setFieldValue("ipk_min", value)
                                            }}
                                            allowNegative={false}
                                            decimalScale={2}
                                            thousandSeparator
                                ...
                                <div className="col-12">
                                    <div className="mb-2">
                                        <label className="my-1 me-2" for="country">IPK Rata-rata <span className="text-danger">*</span></label>
                                        <NumericFormat
                                            className="form-control"
                                            value={formik.values.ipk_avg}
                                            onValueChange={values=>{
                                                const {value}=values

                                                formik.setFieldValue("ipk_avg", value)
                                            }}
                                            allowNegative={false}
                                            decimalScale={2}
                                            thousandSeparator
                                ...
                                <div className="col-12">
                                    <div className="mb-2">
                                        <label className="my-1 me-2" for="country">IPK Maks <span className="text-danger">*</span></label>
                                        <NumericFormat
                                            className="form-control"
                                            value={formik.values.ipk_max}
                                            onValueChange={values=>{
                                                const {value}=values

                                                formik.setFieldValue("ipk_max", value)
                                            }}
                                            allowNegative={false}
                                            decimalScale={2}
                                            thousandSeparator
        ...
        <Modal show={props.data.is_open} onHide={props.toggleEdit} backdrop="static" size="md">
            ...
            >
                {formik=>(
                    <form onSubmit={formik.handleSubmit}>
                        <Modal.Header closeButton>
                            <h4 className="modal-title">Edit IPK Lulusan</h4>
                        </Modal.Header>
                        <Modal.Body>
                            <div className="row">
                                <div className="col-12">
