...
const Page=(props)=>{
    ...
    const get_lakin=useQuery({
        queryKey:["get_lakin_penelitian_kegiatan_pengabdian_masyarakat", filter],
...
const Table=(props)=>{
    ...
    const upsert_lakin=useMutation({
        ...
        onSuccess:data=>{
            queryClient.refetchQueries("get_lakin_penelitian_kegiatan_pengabdian_masyarakat")
        },
        onError:err=>{
            console.log(err)
                                ...
                                <tbody>
                                    {!props.data.isFetching?
                                        <>
                                            ...
                                            {!_.isNull(props.data.error)&&
                                                <tr>
                                                    <td colSpan={9} className="text-center cursor-pointer" onClick={()=>queryClient.refetchQueries("get_lakin_penelitian_kegiatan_pengabdian_masyarakat")}>
